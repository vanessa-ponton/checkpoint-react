    ...
    <>
      ...
      <section className="instructions">
        ...
        <p>
          ...
          <a href="http://localhost:3310">localhost:3310</a>.
        </p>
        <p>
        ...
        <p>
          ...
          <a href="http://localhost:3310/cupcakes">
            localhost:3310/cupcakes
          </a>{" "}
          endpoint. You can add a <em>loader</em> to the <code>/cupcakes</code>{" "}
          route in the
          <code>frontend/src/main.jsx</code> file (and{" "}
          <code>useLoaderData</code> in <code>CupcakeList</code> component), or{" "}
          <em>use an effect</em> (you will then need a state ; be sure to run
          your effect only once).
        </p>
        <p>
      ...
      <section className="instructions">
        ...
        <p>
          ...
          <a href="http://localhost:3310/accessories">
            localhost:3310/accessories
          </a>{" "}
          endpoint.
        </p>
        <p>
